...
dimensionality of 1/2.  The Time::Warp module gives the developer some
...
this behavior is forbidden by the second law of thermodynamics.
...
THIS IS NOT A TIME MACHINE.  THIS MODULE CANNOT BE USED TO VIOLATE THE
SECOND LAW OF THERMODYNAMICS.  THIS SOFTWARE IS PROVIDED "AS IS" AND
WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT
LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR
A PARTICULAR PURPOSE.  THIS DISCLAIMER IS INVARIANT WITH RESPECT TO
